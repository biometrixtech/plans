...
from models.soreness import BodyPart, BodyPartLocation, AssignedExercise, AthleteGoal, AthleteGoalType, ExerciseDosage, \
    Soreness, Alert, BodyPartSide, TriggerType, HistoricSorenessStatus
