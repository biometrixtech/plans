...
class PlannedWorkoutLoadDatastore(object):
    ...
    def get(self, user_profile_id=None, workout_id=None, program_id=None):
        """
        program_id: uuid
        ...
        """
        return self._query_mongodb(user_profile_id, workout_id, program_id)
    ...
    def _query_mongodb(self, user_profile_id, workout_id, program_id):
    ...
    def _put_mongodb(self, item):
        ...
        mongo_collection = get_mongo_collection(self.mongo_collection)
        query = {'user_profile_id': item['user_profile_id'], 'program_id': item['program_id'], 'workout_id': item['workout_id']}
