...
class InjuryRiskDictOutputProcessor(object):
    def __init__(self, file_location, user_id, user_name='test'):
        ...
        self.attribute_list = ['concentric_volume_today','eccentric_volume_today', 'isometric_volume_today',
                'compensating_concentric_volume_today','compensating_eccentric_volume_today','compensating_isometric_volume_today',
    ...
    def write_headers(self, date_string):
        ...
        self.file = open(
            self.file_location + "_" + date_string + '_injury_risk_dict.csv', 'w')
    ...
    def get_attribute_string(self, body_part_injury_risk):
        ...
        for attribute in self.attribute_list:
            ...
            if isinstance(val, list):
                ...
                val = ";".join(new_list)
            elif isinstance(val, StandardErrorRange):
                val = str(val.highest_value())
