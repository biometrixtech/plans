...
def get_user_stats_string(user_stats):
    ...
    user_stats_string = str(user_stats.event_date) + "," + str(len(user_stats.high_relative_load_sessions)) + "," + str(user_stats.high_relative_load_score) + "," + str(user_stats.eligible_for_high_load_trigger) + ","
    ...
    for target_training_exposure in obj.target_training_exposures:
        if is_athlete_target_training_exposure:
            training_string += ("{progression_week:" + str(target_training_exposure.progression_week) +
                                ";exposure_count:" + get_std_error_if_present_string(target_training_exposure,"exposure_count",is_last=True) + ";" + "priority:" + str(target_training_exposure.priority) + ";")
        else:
            training_string += "{exposure_count:" + get_std_error_if_present_string(target_training_exposure, "exposure_count", is_last=True)+";"+ "priority:" + str(target_training_exposure.priority) + ";"
...
def get_ird_string(event_date, body_part_side, body_part_injury_rik):
    ...
    ird_string += (body_part_side.body_part_location.name + "; side:" + str(body_part_side.side) + '; con_load: ' +
                   ...
                   "last_muscle_spasm_level:" + str(body_part_injury_rik.last_muscle_spasm_level) + ";"
                   "last_sharp_level:" + str(body_part_injury_rik.last_sharp_level) + ";"
                   "last_tight_level:" + str(body_part_injury_rik.last_tight_level) + ";"
                   #"last_ache_level:" + str(body_part_injury_rik.last_ache_level) + ";"
                   )
