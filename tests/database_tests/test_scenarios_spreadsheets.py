...
from utils import format_datetime, format_date, parse_date
import random
        ...
        for h1 in historic_soreness_status_1:
            for day_diff in days_sore:
                ...
                if test_parm.no_soreness:
                    ...
                    cool_down_line, line, sline = get_lines(body_part_line, daily_plan, test_parm)
...
def get_lines(body_part_line, daily_plan, test_parm):
