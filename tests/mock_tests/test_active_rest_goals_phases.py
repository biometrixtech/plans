...
from models.functional_movement_modalities import ActiveRestAfterTraining
...
def test_active_rest_check_care_severity_3():
    ...
    for b in body_parts_1:
        ...
        for body_part, body_part_injury_risk in consolidated_injury_risk_dict.items():
            ...
            active_rest.check_care(body_part, body_part_injury_risk, exercise_library, max_severity)
...
def test_active_rest_check_care_severity_7():
...
def test_active_rest_check_prevention_short():
    ...
    body_part_injury_risk_2 = BodyPartInjuryRisk()
    body_part_injury_risk_3 = BodyPartInjuryRisk()
    body_part_injury_risk_4 = BodyPartInjuryRisk()
    body_part_injury_risk_5 = BodyPartInjuryRisk()

    body_part_injury_risk_1.knots_count_last_0_20_days = 3
    body_part_injury_risk_2.tight_count_last_0_20_days = 3
    body_part_injury_risk_3.sharp_count_last_0_20_days = 3
    body_part_injury_risk_4.ache_count_last_0_20_days = 4
    body_part_injury_risk_5.short_count_last_0_20_days = 3

    body_part_injury_risk_list = [
        body_part_injury_risk_1,
        body_part_injury_risk_2,
        body_part_injury_risk_3,
        body_part_injury_risk_4,
        body_part_injury_risk_5
    ]
    ...
    for b in body_part_injury_risk_list:
        ...
        active_rest = ActiveRestAfterTraining(event_date_time=datetime.today())
        active_rest.check_prevention(body_part, b, exercise_library, max_severity, [])
...
def test_active_rest_check_recovery_volume_tier_1_5_severity_3():

    exercise_library = exercise_library_datastore.get()
    max_severity = 3
    body_part_factory = BodyPartFactory()

    volume_tiers = [1, 2, 3, 4, 5]
...
def test_active_rest_check_recovery_volume_tier_1_5_severity_5():
...
def test_active_rest_check_recovery_volume_tier_1_5_severity_7():
