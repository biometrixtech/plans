...
# from models.movement_tags import TrainingType, ProficiencyLevel
...
#     WorkoutProcessor(user_weight=70, user_age=30, proficiency_level=ProficiencyLevel.elite).process_workout(session)
#
#     return session
#
...
#     WorkoutProcessor(user_weight=70, user_age=30, proficiency_level=ProficiencyLevel.elite).process_planned_workout(session, assignment_type=assignment_type, movement_option=movement_option)
#
#     return session
#
#
