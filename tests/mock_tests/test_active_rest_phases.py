...
def test_active_rest_after_training_check_soreness_severity_3():
    ...
    active_rest = ActiveRestAfterTraining([], False, event_date_time=datetime.today())
...
def test_active_rest_after_training_check_prevention_soreness_severity_2():
    ...
    active_rest = ActiveRestAfterTraining([], False, event_date_time=current_date_time)
...
def test_active_rest_before_training_check_soreness_severity_3():
    ...
    active_rest = ActiveRestBeforeTraining([], False, event_date_time=datetime.today())
...
def test_active_rest_before_training_check_prevention_soreness_severity_2():
    ...
    current_date_time = datetime.today()
    active_rest = ActiveRestBeforeTraining([], False, event_date_time=current_date_time)
